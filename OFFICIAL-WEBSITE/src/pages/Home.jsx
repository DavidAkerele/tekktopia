    ...
    <section className="mt-24 md:mt-44 ">
      ...
      <section className="mt-40">
        <div className="flex items-center justify-center gap-12">
          ...
          <div className="w-[588px]">
            <h3 className="text-[32px] font-[400] text-[#0B0B0B] font-[DM-Sans] leading-[45px]">
      ...
      <section className="mt-40 flex flex-col items-center ">
        ...
        <div className="text-center text-[14px] leading-[24px] mx-auto text-[#697D95B2] mt-6 max-w-[700px]">
          ...
          ab illo inventore veritatis et quasi architecto beatae vitae dic.
        </div>
      ...
      <section className="mt-[120px]">
        <h2 className="text-[32px] text-center font-[400]">
          Driving Innovation, Building Prosperity
        </h2>
      </section>
        ...
        <div className="flex items-center justify-center">
          ...
          <div className="mx-8 text-center">
            ...
            <p className="mt-2 text-gray-500">
              &quot; This is an amazing service! Highly recommend it! &quot;
            </p>
          </div>
            ...
            {["article1.png", "article2.png", "article3.png"].map(
              (article, index) => (
                <div key={index} className="space-y-2">
                  ...
                  <span className="text-[#0B0B0B] text-[16px] pt-8 cursor-pointer">
                    Read more -&gt;
                  </span>
                </div>
              )
